      ...
      <header className="fixed top-0 left-0 w-full z-50 bg-black/30 backdrop-blur-lg border-b border-yellow-400/20">
        <div className="max-w-7xl mx-auto flex items-center justify-between py-4 px-6">
          ...
          <div className="relative group">
            <div className="absolute -inset-1 bg-linear-to-r from-yellow-400 to-green-400 rounded-full blur opacity-25 group-hover:opacity-50 transition duration-300"></div>
            <img
              onClick={() => {
                if (audioRef.current) {
          ...
          <nav className="hidden md:flex space-x-8 text-white text-lg font-medium">
            ...
            >
              Models
              <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-linear-to-r from-yellow-400 to-green-400 group-hover:w-full transition-all duration-300"></span>
            </a>
            <a
              href="#"
              className="relative hover:text-yellow-400 transition duration-300 group"
          ...
          <div className="flex items-center space-x-5 text-white text-xl">
            <button className="relative group">
              <div className="absolute -inset-2 bg-linear-to-r from-yellow-400 to-green-400 rounded-full blur opacity-0 group-hover:opacity-30 transition duration-300"></div>
        ...
        {/* Bottom Accent Line */}
        <div className="h-0.5 bg-linear-to-r from-transparent via-yellow-400 to-transparent opacity-30"></div>
      </header>
    </>
  );
};
